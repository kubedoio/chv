  ...
  {#if showForm}
    <div class="card p-4 bg-gray-50">
      ...
      <div class="grid grid-cols-3 gap-4">
        <div>
          <label for="fw-direction" class="block text-sm text-muted mb-1">Direction</label>
        ...
        <div>
          <label for="fw-protocol" class="block text-sm text-muted mb-1">Protocol</label>
        ...
        <div>
          <label for="fw-action" class="block text-sm text-muted mb-1">Action</label>
          <select id="fw-action" 
        ...
        {#if form.protocol === 'tcp' || form.protocol === 'udp'}
          <div>
            <label for="fw-port-range" class="block text-sm text-muted mb-1">Port Range</label>
            <input id="fw-port-range" 
              type="text" 
        ...
        {/if}
        <div>
          <label for="fw-source-cidr" class="block text-sm text-muted mb-1">Source CIDR</label>
          <input id="fw-source-cidr" 
            type="text" 
        ...
        <div>
          <label for="fw-priority" class="block text-sm text-muted mb-1">Priority (100-999)</label>
          <input id="fw-priority" 
            type="number" 
        ...
        <div class="col-span-3">
          <label for="fw-description" class="block text-sm text-muted mb-1">Description (optional)</label>
          <input id="fw-description" 
            type="text" 
