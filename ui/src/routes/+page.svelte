<section class="grid gap-4 lg:grid-cols-3">
  <a class="table-card block p-5 text-inherit no-underline" href="/install">
    ...
    <p class="mt-2 text-sm text-muted">Inspect `/var/lib/chv`, `chvbr0`, SQLite, and the default `localdisk` pool.</p>
  </a>

  <a class="table-card block p-5 text-inherit no-underline" href="/images">
  ...
  <a class="table-card block p-5 text-inherit no-underline" href="/vms">
