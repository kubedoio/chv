...
| [ADR-003-WebUI](../specs/adr/003-webui-navigation-model.md) | Revised WebUI Navigation Model | **Superseded by ADR-006-WebUI** | Primary navigation hierarchy and detail-page tab structure. |
